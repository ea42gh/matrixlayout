...
`ea42gh/jupyter-tikz@f15578ba`; the PyPI `jupyter-tikz` package does not expose
...
| jupyter-tikz | ea42gh/jupyter-tikz `f15578ba` | Required for `render_svg_with_artifacts`; do not substitute PyPI `jupyter-tikz`. |
