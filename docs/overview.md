...
`ea42gh/jupyter-tikz@83ef5874`; the PyPI `jupyter-tikz` package does not expose
...
| jupyter-tikz | ea42gh/jupyter-tikz `83ef5874` | Required for `render_svg_with_artifacts`; do not substitute PyPI `jupyter-tikz`. |
