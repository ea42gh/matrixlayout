...
from matrixlayout.ge import grid_bundle, grid_submatrix_spans, grid_tex
...
def test_ge_grid_bundle_returns_tex_and_spans_consistently():
    ...
    # TeX should match grid_tex for the same inputs.
    assert b.tex == grid_tex(matrices=matrices, Nrhs=0)
