...
def test_grid_tex_decorations_background_submatrix():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
        {"grid": (0, 0), "submatrix": ("0:1", "0:1"), "background": "yellow!25"},
    ]
    tex = grid_tex(matrices=matrices, decorations=decorations, formatter=str, create_medium_nodes=True)
    assert "fill=yellow!25" in tex


def test_grid_tex_decorations_box_submatrix():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
        {"grid": (0, 0), "submatrix": ((0, 0), (0, 1)), "box": True},
    ]
    tex = grid_tex(matrices=matrices, decorations=decorations, formatter=str)
    assert r"\boxed{1}" in tex
    assert r"\boxed{2}" in tex
    assert r"\boxed{3}" not in tex


def test_grid_tex_decorations_color_rows_cols_range():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
...
def test_grid_tex_decorations_color_and_bold():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
...
def test_grid_tex_decorations_outline():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
...
def test_grid_tex_decorations_lines_and_label():
    matrices = [[[1, 2], [3, 4]]]
    decorations = [
        {"grid": (0, 0), "hlines": 1},
        {"grid": (0, 0), "vlines": 1},
...
def test_grid_tex_decorations_lines_submatrix_shorthand():
...
def test_grid_tex_decorations_lines_bounds():
...
def test_grid_tex_decorations_lines_all():
    matrices = [[[1, 2, 3], [4, 5, 6], [7, 8, 9]]]
    decorations = [
